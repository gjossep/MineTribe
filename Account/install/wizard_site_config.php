...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="../../Main CSS/css/favicon.ico" />

    <!-- Bootstrap core CSS -->
    <link href="../../Main CSS/css/bootstrap.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="../../Main CSS/css/jumbotron-narrow.css" rel="stylesheet">

    <link rel="stylesheet" href="../../Main CSS/css/font-awesome.min.css">

    <!-- JavaScript -->
    <script src="../../Scripts/js/jquery-1.10.2.min.js"></script>
    <script src="../../Scripts/js/bootstrap.js"></script>
    <script src="../../Scripts/js/userfrosting.js"></script>

    <!-- Page Specific Plugins -->
    <link rel="stylesheet" href="../../Main CSS/css/bootstrap-switch.min.css" type="text/css" />
